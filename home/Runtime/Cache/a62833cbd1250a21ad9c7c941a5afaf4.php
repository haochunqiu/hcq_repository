...
<link href="__TMPL__css/styles.css" rel="stylesheet">
<link href="__TMPL__css/animation.css" rel="stylesheet">
<!-- 返回顶部调用 begin -->
<link href="__TMPL__css/lrtk.css" rel="stylesheet" />
<script type="text/javascript" src="__TMPL__js/jquery.js"></script>
<script type="text/javascript" src="__TMPL__js/js.js"></script>
<!-- 返回顶部调用 end-->
<!--[if lt IE 9]>
<script src="__TMPL__js/modernizr.js"></script>
<![endif]-->
</head>
<body>
<header>
  <nav id="nav">
    ...
    <script src="__TMPL__js/silder.js"></script><!--获取当前页导航 高亮显示标题--> 
  </nav>
</header>
<!--header end-->
<div id="mainbody">
  <div class="info">
    <figure> <img src="__TMPL__images/art.jpg"  alt="Panama Hat">
  ...
  <div class="blogs">
    <ul class="bloglist">
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="__TMPL__images/s1.jpg"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="__TMPL__images/s2.jpg"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="__TMPL__images/s3.jpg"></a>
      ...
      <li>
        <div class="arrow_box">
          ...
          <h2 class="title"><a href="/" target="_blank">谁更心软，谁就先长大</a></h2>
          <ul class="textinfo">
            <a href="/"><img src="__TMPL__images/s4.jpg"></a>
            <p> 男人都是孩子，需要用一生时间来长大。女人都想当孩子，却最擅长的角色是妈妈。恋爱一开始，是两个孩子之间的游戏，到后来，成了大人和孩子之间的游戏。恋爱这回事，总要有一个人先长大，对另一半多些包容和宠溺。而通常来看：谁更心软，谁就先长大...</p>
          </ul>
          <ul class="details">
            <li class="likes"><a href="#">102</a></li>
      ...
      <li>
        <div class="arrow_box">
          ...
          <ul class="textinfo">
            <a href="/"><img src="__TMPL__images/s5.jpg"></a>
    ...
    <aside>
      ...
      <div class="toppic">
        <h2>图文并茂</h2>
        <ul>
          <li><a href="/"><img src="__TMPL__images/k01.jpg">腐女不可怕，就怕腐女会画画！
            <p>伤不起</p>
            </a></li>
          <li><a href="/"><img src="__TMPL__images/k02.jpg">问前任，你还爱我吗？无限戳中泪点~
            <p>感兴趣</p>
            </a></li>
          <li><a href="/"><img src="__TMPL__images/k03.jpg">世上所谓幸福，就是一个笨蛋遇到一个傻瓜。
            <p>喜欢</p>
            </a></li>
        </ul>
      </div>
      ...
      <div class="viny">
        <dl>
          <dt class="art"><img src="__TMPL__images/artwork.png" alt="专辑"></dt>
          ...
          <dd class="music">
            <audio src="__TMPL__images/nf.mp3" controls></audio>
          </dd>
...
<footer>
  <div class="footer-mid">
    ...
    <div class="visitors">
      <h2>最新评论</h2>
      <dl>
        <dt><img src="__TMPL__images/s8.jpg">
        <dt>
        <dd>DanceSmile
          <time>49分钟前</time>
        </dd>
      ...
      <dl>
        <dt><img src="__TMPL__images/s7.jpg">
        <dt>
        <dd>yisa
          <time>2小时前</time>
        </dd>
      ...
      <dl>
        <dt><img src="__TMPL__images/s6.jpg">
        <dt>
        <dd>小林博客
          <time>8月7日</time>
        </dd>
    ...
    <section class="flickr">
      <h2>摄影作品</h2>
      <ul>
        <li><a href="/"><img src="__TMPL__images/01.jpg"></a></li>
        <li><a href="/"><img src="__TMPL__images/02.jpg"></a></li>
        <li><a href="/"><img src="__TMPL__images/03.jpg"></a></li>
        <li><a href="/"><img src="__TMPL__images/04.jpg"></a></li>
        <li><a href="/"><img src="__TMPL__images/05.jpg"></a></li>
        <li><a href="/"><img src="__TMPL__images/06.jpg"></a></li>
        <li><a href="/"><img src="__TMPL__images/07.jpg"></a></li>
        <li><a href="/"><img src="__TMPL__images/08.jpg"></a></li>
        <li><a href="/"><img src="__TMPL__images/09.jpg"></a></li>
      </ul>
    </section>
  </div>
